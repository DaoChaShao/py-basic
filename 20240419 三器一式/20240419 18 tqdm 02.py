...
# -*- Coding: UTF-8 -*-
# @Time     : 2024/12/31 02:46
# @Author   : Shawn
# @Version  : Version 1.0
# @Fime     : 20240419 18 tqdm 02.py
# @Desc     : 
...
class SQLReader(object):
    ...
    def read(self, col_x: str, col_y: str, col_z: str) -> DataFrame:
        ...
        return DataFrame(chunks, columns=[col_x, col_y, col_z])
