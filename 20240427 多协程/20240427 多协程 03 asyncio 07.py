...
# -*- Coding: UTF-8 -*-
# @Time     : 2024/12/27 18:51
# @Author   : Shawn
# @Version  : V 1.0
# @Fime     : 20240427 多协程 03 asyncio 07.py
# @Desc     :
...
def main() -> None:
    ...
    tasks = [
        names(data_faker, AMOUNT_DATA, WAIT_MIN, WAIT_MAX, DELAY_DEFAULT),
        numbers(data_faker, AMOUNT_DATA, WAIT_MIN, WAIT_MAX, DELAY_DEFAULT),
    ]

    # python 3.8+ has been deprecated this method
    done, pending = run(wait(tasks))
    for task in done:
