...
# -*- Coding: UTF-8 -*-
# @Time     : 2024/12/27 18:36
# @Author   : Shawn
# @Version  : V 1.0
# @Fime     : 20240427 多协程 03 asyncio 04.py
# @Desc     :
...
async def main() -> None:
    ...
    tom = create_task(names(data_faker, AMOUNT_DATA, WAIT_MIN, WAIT_MAX, DELAY_DEFAULT))
    jerry = create_task(numbers(data_faker, AMOUNT_DATA, WAIT_MIN, WAIT_MAX, DELAY_DEFAULT))

    await wait([tom, jerry])
