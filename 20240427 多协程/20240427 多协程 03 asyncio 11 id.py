...
# @Author   : Shawn
# @Version  : Version 1.0
# @Fime     : 20240427 多协程 03 asyncio 11 id.py
# @Desc     : 

from asyncio import run, sleep, gather, create_task, Event, current_task
...
class CalculationGame(object):
    ...
    def __str__(self) -> str:
        return (f"{self._name:>12} {self._task_id}'s result is {self._NUMBER:>08d},"
